...
const DeveloperTools: React.FC = () => {
  ...
  const generateWallet = async (
    ...
    try {
      ...
      if (selectedNetwork === "testnet") {
        ...
        const response = await fetch("https://us-central1-ajudan-tampan.cloudfunctions.net/fundWallet", {
          method: "POST",
          headers: {
        ...
        const response = await fetch(
          "https://us-central1-ajudan-tampan.cloudfunctions.net/generateMainnetWallet",
          {
            method: "POST",
            headers: {
              "Content-Type": "application/json",
  ...
  const handleTokenCreation = async () => {
    ...
    try {
      ...
      const endpoint =
      network === "mainnet"
        ? "https://us-central1-ajudan-tampan.cloudfunctions.net/createTokenMainnet"
        : "https://us-central1-ajudan-tampan.cloudfunctions.net/createTokenTestnet";
