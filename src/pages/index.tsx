    ...
    <WalletContextProvider>
      <>
        ...
        <Head>
          ...
          <meta name="description" content="Create your own token on Solana with Solradian's Developer Tools. Experience the lowest fees and seamless integration into the pool." />
          <meta name="keywords" content="Solana Token Creator, Create Token on Solana, SPL Token, Solradian, Low Fees, Fast Transactions, Tokenization, DeFi, dApps, blockchain" />
          <link rel="canonical" href="https://solradian.com" />
          <meta property="og:title" content="Create Token on Solana - Solradian.com" />
          <meta property="og:description" content="Empower your blockchain projects with Solradian's Developer Tools. Easily create tokens on Solana with low fees and fast transactions." />
          ...
          <meta name="twitter:description" content="Empower your blockchain projects with Solradian's Developer Tools. Easily create tokens on Solana with low fees and fast transactions." />
          ...
          <script
            ...
            dangerouslySetInnerHTML={{
              __html: JSON.stringify({
                ...
                "name": "Solradian",
                "description": "Explore the future of blockchain with Solradian. Built on Solana, we deliver efficiency, scalability, and advanced tokenization solutions globally.",
                "publisher": {
                  "@type": "Organization",
                  "name": "Solradian",
                  "logo": {
        ...
        <header className="flex justify-between items-center px-6 py-4 bg-gray-900 shadow-md sticky top-0 z-50 animate-fade">
          <h1 className="text-2xl font-bold text-neon-cyan">Solradian</h1>
        ...
        <section className="text-center py-12 bg-gradient-to-b from-gray-900 to-gray-800 animate-fade">
          <h2 className="text-4xl md:text-5xl font-extrabold mb-4 md:mb-6 text-neon-pink">
          ...
          <a
            ...
            className="px-5 md:px-6 py-2 md:py-3 bg-neon-cyan text-sm md:text-lg font-semibold text-black rounded-md shadow-md btn-glow hover:bg-neon-pink transition"
          >
            Learn More
          </a>
        </section>
        ...
        <section className="py-16 animate-fade key-features-section">
          <h3 className="text-4xl font-extrabold text-center text-neon-cyan mb-12">
            Key Features
          </h3>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 px-6">
            <div className="feature-item">
              <h4 className="text-2xl font-semibold text-neon-cyan mb-3">
                Low Fees
              </h4>
